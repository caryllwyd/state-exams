...
def plot_progress():
    ...
    plt.legend()
    plt.grid()
    plt.savefig("thesis_progress_plot.png", dpi=300)

# Example Usage
if __name__ == "__main__":
    update = input("Do you want to update? (Y/N): ")
    if update == "Y":
        total_work = int(input("Enter the total amount of work: "))  # Allow user to re-enter total work each time
        new_progress = int(input("Enter your new progress: "))
